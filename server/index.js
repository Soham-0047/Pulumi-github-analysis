...
const io = new SocketIOServer(server, {
  cors: {
    origin: ["http://localhost:5173","https://greencode-setiment.onrender.com","https://greencode-sentiment.netlify.app"], // <-- ✅ Allow all origins (for dev only)
    methods: ["GET", "POST"],
  }
});
...
app.use(cors({
  origin: ["http://localhost:5173","https://greencode-setiment.onrender.com","https://greencode-sentiment.netlify.app"],
